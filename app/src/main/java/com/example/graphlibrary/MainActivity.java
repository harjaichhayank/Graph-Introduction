            ...
            public void onClick(View view) {
                ...
                try {
                    LineGraphSeries<DataPoint> series = new LineGraphSeries<>(new DataPoint[] {
                            new DataPoint(0, 1),
                            new DataPoint(parseInt(firstInput_1), parseInt(secondInput_1)),
                            new DataPoint(parseInt(firstInput_2), parseInt(secondInput_2)),
                            new DataPoint(parseInt(firstInput_3), parseInt(secondInput_3)),
                            new DataPoint(parseInt(firstInput_4), parseInt(secondInput_4))
                    });
